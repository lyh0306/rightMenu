<template>
    <div class="video-container" >
        ...
        <div class="videoControl" id="video_dialog">
            ...
            <div class="video_button" >
                <el-button type="primary"  @mousedown.prevent="ptzControl('left')"> 左</el-button>
                <el-button type="primary"  @mousedown.prevent="ptzControl('up')">上</el-button>
                <el-button type="primary"  @mousedown.prevent="ptzControl('right')"> 右</el-button>
                <el-button type="primary"  @mousedown.prevent="ptzControl('down')">下</el-button>
            </div>
        </div>
    </div>
</template>
